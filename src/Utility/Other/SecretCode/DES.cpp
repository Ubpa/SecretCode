...
string bitsetToStr(const bitset<64> & bit64);

bitset<64> encrypt(const bitset<64> & plain, const vector<bitset<48>> & subKey);

bitset<64> decrypt(const bitset<64> & cipher, const vector<bitset<48>> & subKey);
